...
func (m *BluePrintCreateAccountTx) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BluePrintCreateAccountTx.Merge(m, src)
}
...
func (m *BluePrintStateTx) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BluePrintStateTx.Merge(m, src)
}
...
func (m *BluePrintAppState) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BluePrintAppState.Merge(m, src)
}
...
func (m *StateQueryParams) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StateQueryParams.Merge(m, src)
}
...
func (m *StateQueryResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StateQueryResult.Merge(m, src)
}
